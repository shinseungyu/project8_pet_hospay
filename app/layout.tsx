...
export const metadata: Metadata = {
  ...
  description: '고양이 병원비·강아지 병원비 평균 비용을 항목별로 확인하세요. 고양이 중성화·구내염·방광염, 강아지 슬개골 수술, 스케일링 등 1차/2차 동물병원 비용 비교.',
  keywords: [
    ...
    '고양이 중성화 비용', '고양이 스케일링 비용', '고양이 구내염 치료비',
    '고양이 방광염 치료비', '고양이 요로결석 치료비', '고양이 신장병 치료비',
    '고양이 입원비', '고양이 수술비 평균', '고양이 병원비 얼마',
  ],
  ...
  return (
    <html lang="ko">
      <head>
        ...
        <Script
          async
          src="https://www.googletagmanager.com/gtag/js?id=G-NKGCSCLZGS"
