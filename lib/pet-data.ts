...
export const faqData: FAQ[] = [
  ...
  {
    question: "2026년 동물병원 진료비 평균은 얼마인가요?",
    answer: "2026년 기준 강아지 기본 진찰료는 1만~3만원, 혈액검사는 5만~15만원, 방사선 촬영은 3만~8만원 수준입니다. 고양이의 경우 중성화 수술 15만~30만원, 스케일링 15만~25만원이 평균적입니다. 병원 규모와 지역에 따라 차이가 크므로 본 사이트의 병원비 조회 기능을 활용해 미리 확인해보세요.",
  },
]
